...
public static class LanguageHelper
{
    ...
    private static readonly Dictionary<int, string> LanguageLcids = new()
    {
        { 0x0401, "Arabic" },
        { 0x0402, "Bulgarian" },
        { 0x0403, "Catalan" },
    ...
    private static readonly Dictionary<string, int> Lcids = new(StringComparer.OrdinalIgnoreCase)
    {
        { "ARA", 0x0401 },
        { "AR", 0x0401 },
        { "BUL", 0x0402 },
    ...
    public static string GetLanguageByLcid(int lcid) =>
        LanguageLcids.TryGetValue((lcid & 0x3FF) + 0x400, out var result) ?
            result :
            UnknownLanguage;
    ...
    public static string GetLanguageByShortName(string source) =>
        Languages.TryGetValue(source, out var result) ?
            result :
            string.Empty;
    ...
    public static int GetLcidByShortName(string source) =>
        Lcids.TryGetValue(source, out var result) ?
            result :
            0;
}
